...
CAMARAS_SELECCIONADAS = [0]  # Cambia esto a la ID de tu cámara
LOCK_FILE = ".captura.lock"
MODEL_PATH = r"C:\Users\resendizjg\Downloads\bestV5.pt"  # Ruta al modelo YOLO
GUARDAR_SEGMENTADAS = True
SUBIR_SQL = True  # Controla si se suben datos a la base de datos
TABLA_SQL = "results_refrigerador_danone_iot_dev"  # Nombre de la tabla en SQL Server
...
if __name__ == "__main__":
    ...
    if args.modo == "una_vez":
        if args.modo == "una_vez":
            ...
            #logging.info("Captura de imágenes finalizada. Limpiando directorios...")
            #capturador.limpiar_directorios_una_vez()
